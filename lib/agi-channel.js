    ...
    self.sendRequest(sprintf('CHANNEL STATUS %s', channelName))
      .then(function (reply) {
        ...
        resolve({
          "failure": failure,
          "agiReply": reply,
          "relevantResult": (function () {

            try {

              return failure ? null : parseInt(reply.attributes.result)
        ...
        resolve({
          ...
          "relevantResult": (function () {
            try {
              ...
              return failure ? null : reply.attributes.result
        ...
        resolve({
          ...
          "relevantResult": (function () {
            ...
            try {
              ...
              return reply.extra ? reply.extra : null;
